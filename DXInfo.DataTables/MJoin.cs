...
namespace DataTables
{
    ...
    public class MJoin
    {
        ...
        /// <summary>
        /// Add multi field to the MJoin instance
        /// </summary>
        /// <param name="fields"></param>
        /// <returns></returns>
        public MJoin Field(IEnumerable<Field> fields)
        {
        ...
        internal void Data(Editor editor, DtResponse response)
        {
            ...
            while ((row = result.Fetch()) != null)
            {
                ...
                var lookup = row["_dte_lookup"].ToString();
