    ...
    function createMvsTable() {
                        ...
                        $.ajax({
                            ...
                            success: function (jsonmv) {
                                ...
                                .done(function (json) {
                                    ...
                                    document.location = "/StockMg/OtherInStock?id=" + newvid + '&type=' + vouchtype;
                                })
        ...
        mvseditor.on('preSubmit', function (e, o, action) {
            if (action != 'remove') {
                ...
                $.each(o.data, function (key, val) {
                    if (o.data[key].Vouchs.Price == null || o.data[key].Vouchs.Price == '') {
                        o.data[key].Vouchs.Price = undefined;
                    }
                })
